...
import type { CutterMesh } from './geometry';
...
export function buildThreeMf(parts: ExportPart[], title = 'STL Cutter project'): Uint8Array {
  ...
  const contentTypes = `<?xml version="1.0" encoding="UTF-8"?><Types xmlns="http://schemas.openxmlformats.org/package/2006/content-types"><Default Extension="rels" ContentType="application/vnd.openxmlformats-package.relationships+xml"/><Default Extension="model" ContentType="application/vnd.ms-package.3dmanufacturing-3dmodel+xml"/><Default Extension="txt" ContentType="text/plain"/></Types>`;
  return zipSync({

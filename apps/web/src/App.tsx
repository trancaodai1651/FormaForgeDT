...
function AdminRoute({ children, navigation = true }: { children: ReactNode; navigation?: boolean }) {
  return <AdminGuard>{() => <>{navigation && <AdminWorkspaceNav />}{children}</>}</AdminGuard>;
}

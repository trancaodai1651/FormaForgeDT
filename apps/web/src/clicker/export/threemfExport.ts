...
export function buildThreeMF(rawParts: ClickerPart[]): Uint8Array {
  ...
  const metadata =
    ...
    `<metadata name="Copyright">${esc('Â© Vostok Labs. Generated by the Vostok Labs Clicker Generator.')}</metadata>` +
    `<metadata name="LicenseTerms">${esc(`CC BY-NC-ND 4.0 â€” personal use only. Commercial use requires a license: ${COMMERCIAL_URL}`)}</metadata>` +
  ...
  const provenance = [
    'Vostok Labs â€” Clicker Generator',
    '',
    'This 3MF was generated by the Vostok Labs Clicker Generator.',
    `Build: ${buildId}`,
    `Created: ${creationDate}`,
    '',
    'License: CC BY-NC-ND 4.0 â€” personal use only.',

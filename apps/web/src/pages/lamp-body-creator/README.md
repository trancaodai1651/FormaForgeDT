...
The page supports cylinder, taper, hourglass, pedestal, and lampshade profiles; an advanced vertical profile editor matching the lampshade workflow (draggable points, double-click-to-add points, Bézier handles, curve/sharp toggles, and presets); body, base, neck, socket, wall, resolution, finish, and simulation controls; a real bottom cable/socket through-hole; live Three.js preview; and local ASCII STL export. It is intentionally isolated from `pages/tulip-creator/` and `FlexLampWorkspacePage.tsx`.

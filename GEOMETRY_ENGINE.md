...
The current preview generator produces a deterministic side mesh for cylinder, half-cylinder, landmark, tower, geometric, organic, pattern, multi-panel, stackable and modular shape types. It supports STL, binary GLB, 3MF and basic SVG polygon path parsing.
